...
export const CONTRACT_TERMS_SECTIONS: ContractTermsSection[] = [
  {
    ...
    body: [
      ...
      "The Owner may terminate this Agreement and recover the Vehicle if rent becomes overdue. Any unpaid rent remains payable after termination.",
    ],
  },
  {
    ...
    body: [
      ...
      "If costs owing exceed the bond amount, the Renter remains personally liable for the difference.",
  ...
  },
  {
    ...
    body: [
      ...
      "The Vehicle must not be used for any unlawful purpose, racing, towing, or dangerous driving, and must stay within Victoria unless the Owner approves otherwise in writing.",
  ...
  },
  {
    ...
    body: [
      "The Renter is responsible for the insurance excess and any damage or loss not covered by insurance, including damage from at-fault accidents, negligent driving, unauthorised drivers, or theft caused by negligence.",
  ...
  },
  {
    ...
    body: [
      "Failure to comply with this Agreement may result in recovery action, including engaging debt collection, repossession agents, or legal proceedings where necessary.",
      "The Renter remains liable for unpaid rent, recovery costs, and any other losses incurred by the Owner as a result of a breach.",
    ],
  },
  {
    heading: "Termination",
    body: [
      ...
      "Termination does not remove the Renter's liability for any outstanding debts or damages.",
    ],
  },
  {
    heading: "General",
...
export const CONTRACT_TERMS_NOTE =
  "This is a general starting template and has not been reviewed by a lawyer. Have it reviewed for your specific requirements before relying on it as a binding legal document.";
